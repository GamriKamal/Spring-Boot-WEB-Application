        ...
        <div class="header_text">
            <div class="container">
                <div class="img_poster">
                    <img src="${modelMovie.getPoster_path()}">
                </div>
                <div class="poster_text">
                    <strong>${modelMovie.getTitle()} (${modelMovie.getRelease_date()})</strong>
                    <div class="poster_link">
                        <a href="/welcomePage/additionInfoMovie?movieID=${modelMovie.getId()}"> &#8592; Back to main</a>
                    </div>
                </div>
            </div>
        </div>
